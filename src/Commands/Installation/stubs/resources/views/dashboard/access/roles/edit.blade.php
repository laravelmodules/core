...
@section ('title', __('Role Management') . ' | ' . __('Edit Role'))

@section('page-header')
    <h1>
        {{ __('Role Management') }}
        <small>{{ __('Edit Role') }}</small>
    </h1>
@endsection
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    @include('dashboard.access.includes.partials.role-header-buttons')
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        ...
                        @else
                            <span class="label label-success">{{ __('All') }}</span>
                        @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('sort', null, ['class' => 'form-control', 'placeholder' => __('Sort')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
            </div><!-- /.box-body -->
        </div><!--box-->
