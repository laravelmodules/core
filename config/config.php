...
return [
    ...
    */
    ...
    'stubs' => [
        'enabled' => false,
        'path' => base_path() . '/vendor/amamarul/laravel-modules-maru/src/Commands/stubs',
        'files' => [
            'start' => 'start.php',
            ...
            'breadcrumbs/admin' => 'Breadcrumbs/admin.php',
        ...
        'replacements' => [
            ...
            'sidebar/admin' => ['STUDLY_NAME','LOWER_NAME'],
            'sidebar/dashboard' => ['STUDLY_NAME','LOWER_NAME'],
            'breadcrumbs/admin' => ['STUDLY_NAME','LOWER_NAME'],
